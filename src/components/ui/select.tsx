...
>(({ className, children, ...props }, ref) => {
  // احصل على اتجاه العنصر من الوثيقة
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDown className={`h-4 w-4 opacity-50 ${dir === 'rtl' ? 'mr-auto ml-0' : 'ml-auto mr-0'}`} />
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Item
      ...
      {...props}
    >
      <span className={`absolute ${dir === 'rtl' ? 'right-2' : 'left-2'} flex h-3.5 w-3.5 items-center justify-center`}>
